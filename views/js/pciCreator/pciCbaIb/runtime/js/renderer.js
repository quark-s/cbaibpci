...
define(['pciCbaIb/runtime/js/jquery_2_1_1_amd', 'OAT/util/html'], function($, html){
    ...
    function renderLabels(id, $container, config, assetManager){
        ...
        $labelMin.append($('<img>', {src: assetManager.resolve('pciCbaIb/runtime/assets/ThumbDown.png')}).css({top: 6, marginLeft:12}));
        $labelMax.prepend($('<img>', {src: assetManager.resolve('pciCbaIb/runtime/assets/ThumbUp.png')}).css({top: 2, marginRight:12}));
