 ...
 *
 */
define(['qtiCustomInteractionContext', 'pciCbaIb/runtime/js/jquery_2_1_1_amd', 'pciCbaIb/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){
    'use strict';
